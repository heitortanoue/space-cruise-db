...
CREATE TABLE VIAGEM (
    ...
    ITINERARIO VARCHAR(24) NOT NULL,
...
CREATE TABLE QUARTO_RESERVA (
    ...
    MODELO_NAVE_QUARTO VARCHAR(16) NOT NULL,
...
CREATE TABLE RESERVAS (
    QUARTO_RESERVA CHAR(32) NOT NULL,
...
CREATE TABLE CARACTERISTICAS_PONTO_PARADA (
    NOME_PONTO VARCHAR(16) NOT NULL,
...
CREATE TABLE COMPRA (
    QUARTO_RESERVA CHAR(16) NOT NULL,
    COD_BARRAS CHAR(13) NOT NULL,

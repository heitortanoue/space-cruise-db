...
>>>>>>> 954d5cedd899cba9a6d1f7c920031d6b846eca5a
...
CREATE TABLE FUNCIONARIO (
    ...
    CONSTRAINT CK_FUNC_CARGO CHECK(CARGO IN('COMUM', 'COMISSARIO', 'CAPITAO'))
);
...
=======
    TURNO VARCHAR(12) NOT NULL,             -- só ta definido como "manha", "tarde" e "noite"
...
CREATE TABLE CAPITAO (
    ...
    CONSTRAINT CK_CAPITAO_LICENCA CHECK(LICENCA IN('A', 'B', 'C', 'D', 'E'))
);
...
=======
    ...
    CONSTRAINT PK_MODELO_NAVE PRIMARY KEY(NOME),
    CONSTRAINT CHECK_TIPO_NAVE CHECK(TAMANHO IN ('GRANDE', 'PEQUENO', 'MEDIO'))
>>>>>>> 954d5cedd899cba9a6d1f7c920031d6b846eca5a
);
...
CREATE TABLE LICENCAS_PERMITIDAS (
    ...
    CONSTRAINT CK_LICENCAS CHECK(LICENCA IN('A', 'B', 'C', 'D', 'E'))
);
...
CREATE TABLE ITINERARIO (
    ...
    ROTA VARCHAR(32*10) NOT NULL,           --idealmente o maximo sao 10 pontos de paradas

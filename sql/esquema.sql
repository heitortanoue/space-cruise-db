...
CREATE TABLE LICENCAS_PERMITIDAS (
    NOME_MODELO VARCHAR(24) NOT NULL,
    LICENCA CHAR(1) NOT NULL,
    ...
    CONSTRAINT CK_LICENCAS CHECK(LICENCA IN('A', 'B', 'C', 'D'))
);
...
CREATE TABLE QUARTO_RESERVA (
    ...
    CONSTRAINT UN_QUARTO_RESERVA UNIQUE(
        NAVE_VIAGEM,
        DATA_VIAGEM,
        MODELO_NAVE_QUARTO,
        NUMERO_QUARTO
...
CREATE TABLE ITINERARIO (
    ...
    ROTA VARCHAR(320) NOT NULL,
    --idealmente o maximo sao 10 pontos de paradas
    CONSTRAINT PK_ITINERARIO PRIMARY KEY(NOME) --CONSTRAINT FK_ITINERARIO_ROTA FOREIGN KEY(ROTA) REFERENCES parada_itinerario()
);
...
CREATE TABLE PRODUTOS_ITINERARIO (
    NOME_ITINERARIO VARCHAR(24) NOT NULL,
    COD_BARRAS_PRODUTO CHAR(15) NOT NULL,
    ...
    CONSTRAINT CH_PRODUTOS_ITI_COD_BARRAS CHECK(
        COD_BARRAS_PRODUTO ~ '[0-9]{1}\ [0-9]{6}\ [0-9]{6}'
    )
);
...
CREATE TABLE SERVICOS (
    ...
    CONSTRAINT CH_SERVICOS_COD_BARRAS CHECK(
        REGEXP_LIKE(COD_BARRAS, '[0-9]{1}\ [0-9]{6}\ [0-9]{6}')
    )
);

CREATE TABLE SERVICOS_ITINERARIO (
    NOME_ITINERARIO VARCHAR(24) NOT NULL,
    COD_BARRAS_SERVICO CHAR(15) NOT NULL,
    ...
    CONSTRAINT CH_SERVICOS_ITI_COD_BARRAS CHECK(
        REGEXP_LIKE(
            COD_BARRAS_SERVICO,
            '[0-9]{1}\ [0-9]{6}\ [0-9]{6}'
        )
